...
* \brief Configuration options (a set of defines and values).
*
*  This lists a set of compile-time options you need to use to enable
...
#define MBED_CLOUD_CLIENT_PROFILE MBED_CLOUD_CLIENT_PROFILE_LITE
...
*
* \brief This is a mandatory macro and you must enable it. Define it like this: `#define MBED_CLOUD_CLIENT_ENDPOINT_TYPE "default"`.
*/
...
*
* \brief This is a mandatory macro and you must enabled it. Define it like this: `#define MBED_CLOUD_CLIENT_LIFETIME 3600`.
...
*
* \brief This is a mandatory macro and is set to 0 by default. This implies that the client picks a random port
