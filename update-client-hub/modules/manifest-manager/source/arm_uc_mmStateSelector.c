...
// Placeholder for init
            ...
            case ARM_UC_MM_STATE_INIT:
                ...
                if (err.code == ERR_NONE) {
                    ...
                    ARM_UC_PostCallback(arm_uc_mmPersistentContext.applicationEventHandler,
                                        ARM_UC_MM_RC_DONE);
                }
                break;
#endif
            case ARM_UC_MM_STATE_INSERTING:
                ...
                if (err.code == ERR_NONE) {
                    err = ARM_UC_mmSetState(ARM_UC_MM_STATE_IDLE);
                    ARM_UC_PostCallback(arm_uc_mmPersistentContext.applicationEventHandler, ARM_UC_MM_RC_DONE);
                }
                break;
