...
#elif defined(ARM_UC_FEATURE_IDENTITY_KVSTORE) && (ARM_UC_FEATURE_IDENTITY_KVSTORE == 1)
extern const ARM_PAL_DEVICE_IDENTITY arm_uc_device_identity_kvstore;
static const ARM_PAL_DEVICE_IDENTITY *arm_uc_device_identity =
    &arm_uc_device_identity_kvstore;
#else
