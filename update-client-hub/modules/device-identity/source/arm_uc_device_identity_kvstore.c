...
#if defined(ARM_UC_FEATURE_IDENTITY_KVSTORE) && (ARM_UC_FEATURE_IDENTITY_KVSTORE == 1)
 ...
 * @return Error code.
 */
static arm_uc_error_t pal_kvstore_internal_set_guid(const arm_uc_guid_t *guid,
 ...
 * @return Error code.
 */
static arm_uc_error_t pal_kvstore_internal_get_guid(arm_uc_guid_t *guid,
                                                    cloud_client_param key)
{
 ...
 * @return Error code.
 */
static bool pal_kvstore_internal_compare(const arm_uc_guid_t *guid,
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_setVendorGuid(const arm_uc_guid_t *guid)
{
    return pal_kvstore_internal_set_guid(guid,
                                         UPDATE_VENDOR_ID);
}
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_getVendorGuid(arm_uc_guid_t *guid)
{
    return pal_kvstore_internal_get_guid(guid,
                                         UPDATE_VENDOR_ID);
}
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_setClassGuid(const arm_uc_guid_t *guid)
{
    return pal_kvstore_internal_set_guid(guid,
                                         UPDATE_CLASS_ID);
}
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_getClassGuid(arm_uc_guid_t *guid)
{
    return pal_kvstore_internal_get_guid(guid,
                                         UPDATE_CLASS_ID);
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_setDeviceGuid(const arm_uc_guid_t *guid)
{
    return pal_kvstore_internal_set_guid(guid,
                                         INTERNAL_ENDPOINT);
}
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_getDeviceGuid(arm_uc_guid_t *guid)
{
    return pal_kvstore_internal_get_guid(guid,
                                         INTERNAL_ENDPOINT);
}
 ...
 * @return Error code.
 */
arm_uc_error_t pal_kvstore_deviceIdentityCheck(const arm_uc_buffer_t *vendor_buffer,
                                               ...
                                               const arm_uc_buffer_t *device_buffer)
{
    ...
    if (device_buffer &&
        ...
        arm_uc_error_t retval = pal_kvstore_getDeviceGuid(&guid);

        if (retval.code == ERR_NONE) {
            bool is_same = pal_kvstore_internal_compare(&guid, device_buffer);
    ...
    if (class_buffer &&
        ...
        arm_uc_error_t retval = pal_kvstore_getClassGuid(&guid);

        if (retval.code == ERR_NONE) {
            bool is_same = pal_kvstore_internal_compare(&guid, class_buffer);
    ...
    if (vendor_buffer &&
        ...
        arm_uc_error_t retval = pal_kvstore_getVendorGuid(&guid);

        if (retval.code == ERR_NONE) {
            bool is_same = pal_kvstore_internal_compare(&guid, vendor_buffer);
...
const ARM_PAL_DEVICE_IDENTITY arm_uc_device_identity_kvstore = {
    .SetVendorGuid          = pal_kvstore_setVendorGuid,
    .GetVendorGuid          = pal_kvstore_getVendorGuid,
    .SetClassGuid           = pal_kvstore_setClassGuid,
    .GetClassGuid           = pal_kvstore_getClassGuid,
    .SetDeviceGuid          = pal_kvstore_setDeviceGuid,
    .GetDeviceGuid          = pal_kvstore_getDeviceGuid,
    .DeviceIdentityCheck    = pal_kvstore_deviceIdentityCheck
};

#endif // ARM_UC_FEATURE_IDENTITY_KVSTORE
