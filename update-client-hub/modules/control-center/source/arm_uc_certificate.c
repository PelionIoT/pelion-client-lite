...
#elif defined(ARM_UC_FEATURE_CERT_STORE_KVSTORE) && (ARM_UC_FEATURE_CERT_STORE_KVSTORE==1)

extern const struct arm_uc_certificate_api arm_uc_certificate_kvstore_api;
static const struct arm_uc_certificate_api *arm_uc_registered_certificate_api =
        &arm_uc_certificate_kvstore_api;

#else

#error No configuration store set

#endif /* ARM_UC_FEATURE_CERT_STORE_KCM/RAW/KVSTORE */
