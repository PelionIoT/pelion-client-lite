...
#ifndef MAX_SOURCES   // TAPANI todo this should be 1 !!!
// changed to 1
#define MAX_SOURCES 1
// tapani todo this is just to remove unnecessary stuff easy
#if (MAX_SOURCES==1)
        #define OPTIMIZED_UC 1
    #else
        #define OPTIMIZED_UC 0
    #endif
#endif
...
ARM_UC_FEATURE_IDENTITY_KVSTORE
...
ARM_UC_FEATURE_CERT_STORE_KVSTORE
...
#define ARM_UC_FEATURE_CERT_STORE_KVSTORE 0
#endif
...
#define ARM_UC_FEATURE_IDENTITY_KVSTORE 0
...
#if defined (ARM_UC_USE_KVSTORE) && ARM_UC_USE_KVSTORE == 1
#warning "ARM_UC_USE_KVSTORE DEPRECATED, See arm_uc_config.h for new flags."
#define ARM_UC_FEATURE_IDENTITY_NVSTORE 0
#define ARM_UC_FEATURE_IDENTITY_KCM 0
#define ARM_UC_FEATURE_IDENTITY_KVSTORE 1
#define ARM_UC_FEATURE_IDENTITY_RAW_CONFIG 0
#define ARM_UC_FEATURE_PSK_STORE_NVSTORE 0
#define ARM_UC_FEATURE_PSK_STORE_RAW 0
#define ARM_UC_FEATURE_CERT_STORE_KCM 0
#define ARM_UC_FEATURE_CERT_STORE_RAW 0
#define ARM_UC_FEATURE_CERT_STORE_KVSTORE 1
...
#ifndef ARM_UC_FEATURE_IDENTITY_KVSTORE
#define ARM_UC_FEATURE_IDENTITY_KVSTORE 0
...
#ifndef ARM_UC_FEATURE_CERT_STORE_KVSTORE
#define ARM_UC_FEATURE_CERT_STORE_KVSTORE 0
...
#ifndef ARM_UC_FEATURE_CERT_STORE_
#define ARM_UC_FEATURE_CERT_STORE_RAW 0
#endif /* ARM_UC_FEATURE_CERT_STORE_RAW */
...
#error "Please define macro ARM_UC_PROFILE_MBED_CLIENT_LITE=1 or ARM_UC_PROFILE_MBED_CLOUD_CLIENT=1 or ARM_UC_PROFILE_NANO_CLIENT=1"
...
#ifndef ARM_UC_EVENT_POOL_SIZE
#define ARM_UC_EVENT_POOL_SIZE 3
#endif
