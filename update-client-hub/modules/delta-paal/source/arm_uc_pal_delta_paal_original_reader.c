...
#if (defined(ARM_UC_PROFILE_MBED_CLIENT_LITE) && (ARM_UC_PROFILE_MBED_CLIENT_LITE==1)) || defined(ARM_UC_PROFILE_NANO_CLIENT)
...
#ifdef ARM_UC_PROFILE_NANO_CLIENT
                                                 ORIG_FIRMWARE_DIR, // tapani todo check this
#else
                                                 pal_imageGetFolder(),
#endif
#else
