...
#ifdef MBED_CONF_MBED_CLIENT_ENABLE_MINIMAL_SERVER_URL_PROCESSING
#define MBED_CLIENT_ENABLE_MINIMAL_SERVER_URL_PROCESSING MBED_CONF_MBED_CLIENT_ENABLE_MINIMAL_SERVER_URL_PROCESSING
#endif
