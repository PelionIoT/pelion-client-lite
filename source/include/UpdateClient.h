...
namespace UpdateClient
{
     ...
     */
    ccs_status_e getVendorId(uint8_t* buffer, size_t buffer_size_max, size_t* value_size);
    /**
     ...
     * \retval CCS_STATUS_SUCCESS on success
     */
    ccs_status_e getClassId(uint8_t* buffer, size_t buffer_size_max, size_t* value_size);
    /**
     ...
     * \retval CCS_STATUS_SUCCESS on success
     */
    ccs_status_e getDeviceId(uint8_t* buffer, size_t buffer_size_max, size_t* value_size);
}
